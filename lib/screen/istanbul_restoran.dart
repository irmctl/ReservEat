...
class IstanbulRestoranlar extends StatefulWidget {
  @override
  _IstanbulRestoranlarState createState() => _IstanbulRestoranlarState();
}

class _IstanbulRestoranlarState extends State<IstanbulRestoranlar> {
  @override
