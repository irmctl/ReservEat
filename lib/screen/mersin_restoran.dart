...
class MersinRestoranlar extends StatefulWidget {
  @override
  _MersinRestoranlarState createState() => _MersinRestoranlarState();
}

class _MersinRestoranlarState extends State<MersinRestoranlar> {
  @override
